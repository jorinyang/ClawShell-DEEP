...
class GitHubAdapter:
    ...
    def __init__(
        self,
        token: str = "",
        repo: str = "jorinyang/ClawShell-DEEP",
    ...
    async def read_file(
        ...
        try:
            ...
            logger.exception(f"GitHub read error: {path}")
            return None
    ...
    async def write_file(
        ...
        try:
            ...
            logger.exception("GitHub write error")
            return False
