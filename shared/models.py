...
class NodeInfo(BaseModel):
    node_id: NodeID
    node_type: NodeType = NodeType.GANGLION
...
class CortexInfo(BaseModel):
    ...
    node_type: NodeType = NodeType.CORTEX
    version: str = "2.0.0"
    status: NodeStatus = NodeStatus.ONLINE
    connected_ganglions: int = 0
...
class RepairAction(BaseModel):
    action_id: str
    component: str
    layer: RepairLayer = RepairLayer.SELF_HEALING
    action: str
